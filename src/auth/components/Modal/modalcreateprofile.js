...
const ModalCreateProfile = ({onYes, onCloseModal, isVisible, modalType,}) => {
  ...
  return (
    ...
    >
      <>
        {modalType == 'major' && renderMajor()}
        {modalType == 'down for' && renderDownFor()}
        {modalType == 'interets' && renderInterest()}
