...
import { Container, StackHeader, Text, TextInput, View, Title } from '../../../common';
	...
	return (
		<Container>
			...
			<FlatList
				...
				ListEmptyComponent={<Title type="h6" marginHorizontal={20} marginVertical={20}>No comments found.</Title>}
