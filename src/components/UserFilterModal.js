        ...
        <Content style={styles.content}>
          <View marginVertical={20}>
            <TextInput
              ...
              onChange={setMajor}
            />
            <Select data={['1 year', '2 years']} label="Grad Year" value={gradeYear} onChange={setGradeYear} />
            <Select data={['Business', 'Hiking', 'Reading']} label="Interests" value={interests} onChange={setInterests} />
            <Select data={['City 1', 'City 2']} label="From" value={from} onChange={setFrom} />
            <Select data={['Male', 'Female']} label="Gender" value={gender} onChange={setGender} />
          </View>
