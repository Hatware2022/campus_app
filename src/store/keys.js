...
module.exports = {
  ...
  groupsSearchKeyword: `${app}groupsSearchKeyword`,
  ...
  userId: `${app}userId`,
  eventsSearchKeyword: `${app}eventsSearchKeyword`,
  eventsShowModalFilter: `${app}eventsShowModalFilter`,
  postsClubSearchKeyword: `${app}postsClubSearchKeyword`,
